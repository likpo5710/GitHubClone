//*** SECTION: PROFILE ***
 ...
 var profilePromise = $.getJSON('https://api.github.com/users/likpo5710')
 ...
 //this function assigns html to the API information from GitHub	
	...
	profileObjToHTML += '<h1 class = "name">' + profileObj.name + '</h1>'
 	...
 	profileObjToHTML += 	'<li class = "website"><a href="' + profileObj.blog + '">www.likpo5710.com</a></li>'
 	profileObjToHTML += '</ul>'
 ...
 //*** SECTION: REPOS ***
  ...
  var reposPromise = $.getJSON('https://api.github.com/users/likpo5710/repos')
